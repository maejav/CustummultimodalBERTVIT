...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default = '../../MMBERT/data/roco/all_data', help='path to dataset', required = False)
    ...
    ###119547
    parser.add_argument('--vocab_size', type=int, default=119547, help='vocabulary size')
    ...
    for epoch in range(args.epochs):
        ...
        print("epocccccchhhhhhhhhhhhhhhhhhhh", epoch)
        ...
        # if (epoch+1) % save_recorder == 0:
        name = f'{args.run_name}{(epoch+1)}.pt'
